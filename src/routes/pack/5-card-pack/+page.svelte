		...
		>
			<div class="md:row-end-1 md:col-span-4 space-y-4">
				...
				>
					<img
						...
						alt={`Cards on grass`}
						class="rounded-3xl object-center object-cover drop-shadow-card hidden md:block"
					/>
				</button>
			</div>
			<div class="max-w-2xl mx-auto md:max-w-none md:mt-0 md:row-end-2 md:row-span-2 md:col-span-4">
				<div class="rounded-3xl bg-white p-6 mt-8 drop-shadow-card">
						...
						<div class="flex flex-col space-y-4">
							...
							>
								<img
									src={`${assets}/images/cards-on-grass.webp`}
									alt={`Cards on grass`}
									class="rounded-3xl object-center object-cover drop-shadow-card md:hidden"
								/>
					...
					>
						...
						<dd class="pt-1 prose max-w-none text-gray-500">
							<p>
								<strong>Some birds only hide in card packs.</strong> Card Packs is Birdables approach
				...
				>
					...
					<dl>
						<dt class="mt-4 font-semibold text-base text-gray-900">
						...
						<dt class="mt-4 font-semibold text-base text-gray-900">
							Can my collection make a difference?
						</dt>
						<dd class="mt-2 prose max-w-none text-gray-500">
							<p>
								Great question, and YES! <strong>We donate a portion of profits</strong> to a bird
								conservation organizations like the <ExternalLink
								...
								>, and other. As the business gets off the ground (pun intended), we'll share more
								details on our site, including donation amounts and recipients.
							</p>

							<p>
								To ensure Birdables is not contributing to the destruction of bird habitats, we only
								use <strong>100% recycled paper</strong> for all physical cards. No trees are cut down
								for the creation of Birdables.
							</p>
				...
				<div class="border-t border-gray-300 mt-10 pt-10">
					...
					<Share
						...
						image={`https://birdables.com${assets}/images/packs/5-card-pack.webp`}
						alt={`5 Card Pack`}
...
>
	<div class={`flex items-center justify-center min-h-screen text-center sm:block sm:p-0`}>
		...
		<div
			...
			} h-screen w-screen pointer-events-none flex justify-center items-center transform transition-all duration-300 ease-in-out px-2 py-12`}
		>
			<img
				src={`${assets}/images/cards-on-grass.webp`}
				alt={`Cards on grass`}
