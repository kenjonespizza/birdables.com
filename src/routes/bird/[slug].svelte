...
<div class="bg-gray-blue">
  ...
  <div class="mx-auto pt-8 pb-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
    ...
    <div class=" pt-8 md:grid md:grid-rows-1 md:grid-cols-8 md:gap-x-8 md:gap-y-10 xl:gap-x-16">
      <!-- Product image -->
      <button on:click={toggleModal} class="md:row-end-1 md:col-span-4 rounded-3xl focus:outline-none focus:ring-3 focus:ring-offset-3 focus:ring-offset-gray-blue focus:ring-gray-500">
        <img src={`${assets}/images/cards/${bird.friendlyId}.png`} alt={`${bird.birdName} card`} class="object-center object-cover drop-shadow-card hidden md:block">
      </button>
      ...
      <div class="max-w-2xl mx-auto mt-14 sm:mt-16 md:max-w-none md:mt-0 md:row-end-2 md:row-span-2 md:col-span-4">
          ...
          <div class="mt-4">
            <div class="text-lg leading-6 font-medium space-y-2">
              <h1 class="flex flex-col">
                <span class="text-2xl md:text-3xl lg:text-5xl tracking-tight leading-none">{bird.smallName}</span>
        ...
        <button on:click={toggleModal} class="focus:ring-3 focus:ring-offset-3 focus:ring-offset-gray-blue focus:ring-gray-500">
          <img src={`${assets}/images/cards/${bird.friendlyId}.png`} alt={`${bird.birdName} card`} class="object-center object-cover drop-shadow-card md:hidden mt-10">
        </button>

        <!-- <p class="text-gray-500 mt-6">The Application UI Icon Pack comes with over 200 icons in 3 styles: outline, filled, and branded. This playfull icon pack is tailored for complex application user interfaces with a friendly and legible look.</p> -->
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4">
          ...
          {/if}
          <a href="https://opensea.io" type="button" class="w-full bg-gray-900 border border-transparent rounded-full py-4 px-8 flex flex-wrap items-center justify-center text-base font-semibold text-white transition hover:ring-3 hover:ring-offset-3 hover:ring-offset-gray-blue hover:ring-gray-500 focus:outline-none focus:ring-3 focus:ring-offset-3 focus:ring-offset-gray-blue focus:ring-gray-500">
            <span>Buy <span class="font-black">NFT Card</span> on</span>
            <svg class="h-6 transform translate-y-0. ml-2 text-white" viewBox="0 0 437 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M100 50C100 77.6127 77.6127 100 50 100C22.3873 100 0 77.6127 0 50C0 22.3873 22.3873 0 50 0C77.6185 0 100 22.3873 100 50Z" fill="#2081E2"/>
              <path d="M24.6679 51.6801L24.8836 51.341L37.8906 30.9932C38.0807 30.6953 38.5276 30.7261 38.6714 31.0497C40.8444 35.9196 42.7194 41.9762 41.841 45.7468C41.466 47.2982 40.4386 49.3992 39.2827 51.341C39.1338 51.6236 38.9694 51.901 38.7947 52.1681C38.7125 52.2914 38.5738 52.3633 38.4248 52.3633H25.048C24.6884 52.3633 24.4778 51.9729 24.6679 51.6801Z" fill="white"/>
        ...
        <dl id="tab-panel-faq" class="border-t border-gray-300 mt-10 pt-10 text-sm text-gray-500" aria-labelledby="tab-faq" role="tabpanel" tabindex="0">
          ...
          <dd class="mt-2 prose max-w-none text-gray-500">
            <p>Sure thing!  The physical cards are 2.5"x3.5" cards printed on high quality 100% recycled paper.  These cards are just the right thickness to feel satisfyingly sturdy, yet have a slight bend.  They also have a cross-hatch texture, giving it a crisp look and hand feel</p>
          </dd>
          
          <dt class="mt-6 font-semibold text-base text-gray-900">What's the NFT version of a card?</dt>
          <dd class="mt-2 prose max-w-none text-gray-500">
            <p>The NFT version of Birdables cards is a digital version that you keep in your crypto wallet. This NFT is proof of your ownership and is verifiable on the nomutable <a href="https://polygon.technology/" target="_blank" noreferrer class="underline">Polygon</a> blockchain.  Purchases of the NFT will come with access to the hi-res artwork, not available anywhere else.  NFT's of Birdables cards are also more scarce than physical cards.</p>
          </dd>
        ...
        <div class="border-t border-gray-300 mt-10 pt-10">
          ...
          <Share
            ...
            image={`https://birdables.com${assets}/images/cards/${bird.friendlyId}.png`} alt={`${bird.birdName} card`}
  ...
  <div class={`flex items-center justify-center min-h-screen text-center sm:block sm:p-0`}>
    <!--
      ...
      Leaving: "ease-in duration-200"
        ...
        To: "opacity-0"
    -->
    <div on:click={toggleModal} class={`${isModalOpen ? "opacity-100" : "opacity-0"} fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity duration-300 ease-in-out`} aria-hidden="true"></div>
    ...
    -->
    <div class={`${isModalOpen ? "opacity-100 translate-y-0 sm:scale-100" : "opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"} h-screen w-screen pointer-events-none flex justify-center items-center transform transition-all duration-300 ease-in-out px-6 py-12`}>
        <img src={`${assets}/images/cards/${bird.friendlyId}.png`} alt={`${bird.birdName} card`} class={`${isModalOpen ? "pointer-events-auto" : "pointer-events-none"} object-center object-cover drop-shadow-card max-h-[calc(100vh-6rem)]`}>
    </div>
