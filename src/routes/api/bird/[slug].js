...
import {returnBirdFromSlug, returnFormattedBirds, returnEtsyListingFromEtsyListingId, returnEtsyImagesFromEtsyListingId, addDataToBirdArr} from "$lib/utils"
...
export async function get({ params }) {
  ...
  const data = returnBirdFromSlug(slug, returnFormattedBirds(records));
