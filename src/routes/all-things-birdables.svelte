  ...
  <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
    <div class="relative sm:py-16 lg:py-0">
      ...
      <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
        ...
        <div class="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
          ...
          <div class="absolute inset-0 bg-gradient-to-t from-gray-600 via-gray-600 opacity-90"></div>
          <div class="relative px-8">
            ...
            <blockquote class="mt-8">
              <div class="relative text-lg font-medium text-white md:flex-grow">
                <svg class="absolute top-0 left-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-gray-400" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
              ...
              <footer class="mt-4">
                <p class="text-base font-semibold text-gray-200">Sarah Williams, CEO at Workcation</p>
              </footer>
            </blockquote>
          </div>
        </div>
    ...
    <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
      ...
      <div class="mt-10">
        ...
        <div class="mt-10">
          <a href="/" class="text-base font-medium text-gray-600"> Learn more about how we're changing the world <span aria-hidden="true">&rarr;</span> </a>
        </div>
      </div>
    </div>
  </div>
