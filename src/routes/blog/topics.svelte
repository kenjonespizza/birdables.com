  ...
  <div class="max-w-7xl mx-auto pt-10 pb-12 px-4 sm:px-6 md:px-8">
    ...
    <div class="md:flex md:justify-between items-end">
      <div class="max-w-3xl pt-8">
        <h2 class="text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tighter lg:text-6xl">Birdables Topics <span class="tracking-tight italic text-gray-300 text-4xl">({topics.length})</span></h2>
        <p class="mt-4 text-xl text-gray-500">Browse the blog by topics to help find exactly what you need.</p>
      </div>
    </div>
  </div>
</section>
...
<div class="bg-white">
  <div class="mx-auto py-12 px-4 max-w-screen-xl sm:px-6 lg:px-8 lg:py-24">
    <div class="flex flex-wrap">
      ...
      <a href={`/blog/topic/${topic}`} rel=prefetch class="text-4xl font-bold mr-8 mb-4 inline-flex items-center hover:text-beak-600 hover:underline">
