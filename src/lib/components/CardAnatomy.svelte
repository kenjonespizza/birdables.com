...
<a target="_blank" noreferrer href={`${assets}/images/Birdable-Card-Anatomy.jpg`} class="block overflow-hidden rounded-2xl md:rounded-2xl lg:rounded-5xl group mt-10 relative">
