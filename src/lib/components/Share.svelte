  ...
  let href;
    ...
    if (site) {
      ...
      if (site === 'twitter') {
        ...
        query = [
          1===1     && `app_id=966242223397117`,
          url      && `link=${encodeURIComponent(url)}`,
          image    && `picture=${encodeURIComponent(image)}`,
          1===1 && `name=Birdables`,
          text && `caption=${encodeURIComponent(text)}`,
...
<ul role="list" class="flex items-center space-x-6 mt-4">
  ...
  <li>
    <a href="https://instagram.com/birdables_cards" target="_blank" rel="noopener" noreferrer class="flex items-center justify-center w-6 h-6 text-gray-400 hover:text-gray-500">
  ...
  <li>
    <button href="#" data-share="facebook" class="flex items-center justify-center w-6 h-6 text-gray-400 hover:text-gray-500" on:click={(e) => {
      open(e, "facebook")
    }}>
      <span class="sr-only">Share on Facebook</span>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path fill="currentColor" d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z"/></svg>
    </button>
  </li>
  <li>
    <button data-share="email" class="flex items-center justify-center w-6 h-6 text-gray-400 hover:text-gray-500" on:click={(e) => {
      open(e, "email")
    }}>
      <span class="sr-only">Share via email</span>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path fill="currentColor" d="M22 20.007a1 1 0 0 1-.992.993H2.992A.993.993 0 0 1 2 20.007V19h18V7.3l-8 7.2-10-9V4a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v16.007zM4.434 5L12 11.81 19.566 5H4.434zM0 15h8v2H0v-2zm0-5h5v2H0v-2z"/></svg>
    </button>
  </li>
